...
BubiFM77AV40EX が使う eFM77AV40EX エミュレーションコアの FFI プラグイン。
  ...
  plugin_root = '${PODS_ROOT}/../Flutter/ephemeral/.symlinks/plugins/bubifm77av40ex_core/macos'
  ...
  s.script_phase = {
    ...
    :output_files => ['${PODS_TARGET_SRCROOT}/cmake_build/macosx/libbubifm77av40ex_core_plugin.a'],
  ...
  s.user_target_xcconfig = {
    ...
    'HEADER_SEARCH_PATHS' => '$(inherited) $(PODS_ROOT)/../../native/bridge/include',
    'OTHER_LDFLAGS' => "$(inherited) -force_load #{plugin_root}/cmake_build/macosx/libbubifm77av40ex_core_plugin.a -Wl,-export_dynamic -lc++",
