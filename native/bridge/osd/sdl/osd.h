/*
	...
	BubiFM77AV40EX: host independent OSD declarations.

	BubiX1turboZ の同名ファイルを出発点にしている。M0では
	コアがリンクできる最小の骨組みであり、640x400のFM77AV40EX画面と
	FM7キーコード、SoLoud向けPCM供給はM1 WP3/WP4で作り直す。
